About essspectroscopy-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/essspectroscopy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/essspectroscopy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add essspectroscopy
# for installing globally
pixi global install essspectroscopy
```
...
It is possible to list all of the versions of `essspectroscopy` available on your platform:
...
```
pixi search essspectroscopy --channel conda-forge
```
